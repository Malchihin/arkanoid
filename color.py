...
#bluetoch
class mySerial:
    """Class for exchanging information aaaaaaabetween RaspBerry and Arduino"""
    ...
    def send(self, message):
        ...
        self.ser.write(message.encode("utf-8")) #reit meseng
...
if __name__ == "__main__":
    ...
    arduino_ser = mySerial()


while True:

    arduino_ser.send (str(int(f'{result}{hit}')) + '\n')
